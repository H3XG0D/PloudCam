...
class TrafficCounter(object):
    ...
    def _draw_bounding_boxes(self,frame,contour_id,bounding_points,cx,cy,prev_cx,prev_cy):
        ...
        cv2.line(frame,(prev_cx,prev_cy),(cx,cy),(0,0,255),1)          
    ...
    def make_collage_of_four(self,up_left_img,up_right_img,down_left_img,down_right_img):
        ...
        self.collage_frame[0:middle_height,0:middle_width]                      = up_l    
    ...
    def main_loop(self):
        ...
        while True:
            ...
            cv2.imshow('Masked Frame',working_img)              
            cv2.imshow('Background-Subtracted',subtracted_img) 
            cv2.imshow('Threshold Applied',dilated_img)     
            cv2.imshow('Running Avg of Background',background_avg)
            cv2.line(img,self.p1_count_line,self.p2_count_line,(0,0,255),1)  
